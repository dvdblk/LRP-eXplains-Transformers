...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.LayerNorm = lm.LayerNormEpsilon(
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if (
            ...
            warnings.warn(
                "relative_key or relative_key_query position embedding type is NOT tested with LXT!"
            )
            ...
            if self.position_embedding_type == "relative_key":
                ...
                attention_scores = lf.add2(
                    attention_scores, relative_position_scores.detach()
                )
...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        if self.is_decoder and encoder_hidden_states is not None:
            ...
            present_key_value = lf.add2(present_key_value, cross_attn_present_key_value)
